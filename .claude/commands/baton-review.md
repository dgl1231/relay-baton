---
description: Review relay-baton implementation for architecture, token diet, auth safety, fallback flow, MVP scope.
...
5. MVP Scope
   - no daemon
   - no VS Code / Visual Studio extension
   - no tmux manager
