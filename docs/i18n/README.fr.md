...
**Dernière: v1.3.1** — [English](../../release-notes/v1.3.1.md) · [한국어](../../release-notes/ko/v1.3.1.md) · [Français](../../release-notes/fr/v1.3.1.md)

relay-baton est **disponible en version stable (GA) depuis v1.0.0** ; la plus récente est **v1.3.1**.
