...
| `relay-baton plan "<task>"` | Plan-execute : le planificateur écrit `plan.md` (`--with`, `--no-run`, `--then-execute`) |
...
**Dernière :** v1.4.0-alpha.0 — [English](../../release-notes/v1.4.0-alpha.0.md) · [한국어](../../release-notes/ko/v1.4.0-alpha.0.md)
