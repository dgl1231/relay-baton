...
| `relay-baton route "<task>"` | Aperçu de l’indication de routage (lecture seule, `--json`) |
...
**Dernière: v1.5.1** — [English](../../release-notes/v1.5.1.md) · [한국어](../../release-notes/ko/v1.5.1.md) · [Français](../../release-notes/fr/v1.5.1.md)

relay-baton est **disponible en version stable (GA) depuis v1.0.0** ; la plus récente est **v1.5.1**.
