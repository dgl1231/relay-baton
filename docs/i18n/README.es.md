...
**Última: v1.5.0** — [English](../../release-notes/v1.5.0.md) · [한국어](../../release-notes/ko/v1.5.0.md) · [Español](../../release-notes/es/v1.5.0.md)

relay-baton llegó a **disponibilidad general (GA) en v1.0.0**; la más reciente es **v1.5.0**.
