...
**Última: v1.6.1** — [English](../../release-notes/v1.6.1.md) · [한국어](../../release-notes/ko/v1.6.1.md) · [Español](../../release-notes/es/v1.6.1.md)

relay-baton llegó a **disponibilidad general (GA) en v1.0.0**; la más reciente es **v1.6.1**.
