...
**Последняя: v1.5.1** — [English](../../release-notes/v1.5.1.md) · [한국어](../../release-notes/ko/v1.5.1.md) · [Русский](../../release-notes/ru/v1.5.1.md)

relay-baton **вышел в стабильную версию (GA) v1.0.0**; последняя — **v1.5.1**.
