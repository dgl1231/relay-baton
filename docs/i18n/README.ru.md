...
**Последняя: v1.5.0** — [English](../../release-notes/v1.5.0.md) · [한국어](../../release-notes/ko/v1.5.0.md) · [Русский](../../release-notes/ru/v1.5.0.md)

relay-baton **вышел в стабильную версию (GA) v1.0.0**; последняя — **v1.5.0**.
