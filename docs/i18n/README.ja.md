...
**最新: v1.4.1** — [English](../../release-notes/v1.4.1.md) · [한국어](../../release-notes/ko/v1.4.1.md) · [日本語](../../release-notes/ja/v1.4.1.md)

relay-baton は **v1.0.0 で正式リリース(GA)** され、現在の最新は **v1.4.1** です。
