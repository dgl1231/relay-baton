...
|---|---|---|---|
| v0.3.0 | [notes](../../release-notes/v0.3.0.md) | [릴리즈 노트](../../release-notes/ko/v0.3.0.md) | 副作用のない `ProjectResolver`、壊れた `projects.json` の自動バックアップ/復旧、`RELAY_BATON_PROJECTS_FILE` 環境変数オーバーライド、fallback 時の `lastError` クリーンアップ。 |
