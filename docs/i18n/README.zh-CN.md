...
|---|---|---|---|
| v0.3.0 | [notes](../../release-notes/v0.3.0.md) | [릴리즈 노트](../../release-notes/ko/v0.3.0.md) | 无副作用的 `ProjectResolver`、损坏的 `projects.json` 自动备份/恢复、`RELAY_BATON_PROJECTS_FILE` 环境变量覆盖、fallback 时清理 `lastError`。 |
