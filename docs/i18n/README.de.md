...
**Aktuell: v1.5.0** — [English](../../release-notes/v1.5.0.md) · [한국어](../../release-notes/ko/v1.5.0.md) · [Deutsch](../../release-notes/de/v1.5.0.md)

relay-baton ist **seit v1.0.0 allgemein verfügbar (GA)**; aktuell ist **v1.5.0**.
