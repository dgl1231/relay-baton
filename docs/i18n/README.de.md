...
**Aktuell: v1.3.1** — [English](../../release-notes/v1.3.1.md) · [한국어](../../release-notes/ko/v1.3.1.md) · [Deutsch](../../release-notes/de/v1.3.1.md)

relay-baton ist **seit v1.0.0 allgemein verfügbar (GA)**; aktuell ist **v1.3.1**.
