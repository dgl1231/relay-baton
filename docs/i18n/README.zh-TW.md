...
| `relay-baton route "<task>"` | 建議性路由提示預覽(唯讀, `--json`) |
...
**最新: v1.6.0** — [English](../../release-notes/v1.6.0.md) · [한국어](../../release-notes/ko/v1.6.0.md) · [繁體中文](../../release-notes/zh-TW/v1.6.0.md)

relay-baton 已 **正式發佈(GA)v1.0.0**,目前最新為 **v1.6.0**。
